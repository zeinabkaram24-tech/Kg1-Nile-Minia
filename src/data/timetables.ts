...
// Topic & Week date ranges (Day and Month only without year) - Week 1 starts on 12/9
...
// Empty timetable state: old schedule has been cleared, ready for the new timetable to be uploaded
const EMPTY_CLASS_SCHEDULE: Record<SchoolDay, PeriodSlot[]> = {
  Saturday: [],
  Sunday: [],
  Monday: [],
  Tuesday: [],
...
export const CLASS_TIMETABLES: Record<ClassId, Record<SchoolDay, PeriodSlot[]>> = {
  KG1A: { ...EMPTY_CLASS_SCHEDULE },
  KG1B: { ...EMPTY_CLASS_SCHEDULE },
  KG1C: { ...EMPTY_CLASS_SCHEDULE },
  KG1D: { ...EMPTY_CLASS_SCHEDULE },
  KG1E: { ...EMPTY_CLASS_SCHEDULE },
};
